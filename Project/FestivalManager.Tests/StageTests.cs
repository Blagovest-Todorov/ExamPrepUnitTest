...
namespace FestivalManager.Tests
{
	...
	public class StageTests
    {
        ...
        public void SongNameAndPerformerNameMustNotBeNullAddSongToPerformer()
        {
			...
			Assert.Throws(typeof(ArgumentNullException), () => stage.AddSongToPerformer("WhiteR", null));
        }

		[Test]
		public void AddSongToPerformerSongAdded() 
		{
			var performer = new Performer("Peter", "Petrov", 23);
			var song = new Song("WhiteR", new TimeSpan(0, 1, 34));
			stage.AddPerformer(performer);
			stage.AddSong(song);

			stage.AddSongToPerformer("WhiteR", "Peter Petrov");
		...
		[Test]
		public void StagePlayReturnRightNumbers() 
		{
			var performer = new Performer("Peter", "Petrov", 23);
			var song = new Song("WhiteR", new TimeSpan(0, 1, 34));
			stage.AddPerformer(performer);
		...
		public void AddSongToPerformerSongNotExist() 
		{
			...
			Assert.Throws(typeof(ArgumentException), 
				() => stage.AddSongToPerformer("WhiteR", "Petar Petrov"));
		...
		public void AddSongToPerformerPerformerNotExist() 
		{
			...
			Assert.Throws(typeof(ArgumentException), () => stage.AddSongToPerformer("WhiteR", "Petar Petrov"));
